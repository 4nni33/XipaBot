...
if wget -q https://github.com/4nni33/Annie/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/4nni33/Annie.git
...
echo -e "\033[01;32m\033[01mIniciando AnnieBot!!\n\033[0m"
npm start
