...
if (!img) throw `*[❗𝐈𝐍𝐅𝐎❗] Responde a un video, imagen o inserta un enlace de una imagen que tenga la terminación .jpg el cual desees convertir en sticker, para esto debe usar el comando ${usedPrefix + command}*\n\n\n*[❗𝐈𝐍𝐅𝐎❗] REPLY TO A VIDEO, OR IMAGE OF THE LINK OF AN IMAGE ENDING .jpg IN WHICH IT WILL BE CONVERTED INTO STICKERS, YOU MUST RESPOND USING THE COMMAND ${usedPrefix + command}*`
...
else throw '*[❗𝐈𝐍𝐅𝐎❗] 𝙻𝙾 𝚂𝙸𝙴𝙽𝚃𝙾, 𝙾𝙲𝚄𝚁𝚁𝙸𝙾 𝚄𝙽 𝙴𝚁𝚁𝙾𝚁, 𝚅𝚄𝙴𝙻𝚅𝙰 𝙰 𝙸𝙽𝚃𝙴𝚁𝙽𝚃𝙰𝚁𝙻𝙾. 𝙽𝙾 𝙾𝙻𝚅𝙸𝙳𝙴 Responde a un video, imagen o inserta un enlace de una imagen que tenga la terminación .jpg� .𝚓𝚙𝚐 𝙴𝙻 𝙲𝚄𝙰𝙻 𝚂𝙴𝚁𝙰 𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙸𝙳𝙾 𝙴𝙽 𝚂𝚃𝙸𝙲𝙺𝙴𝚁*\n\n\n*[❗𝐈𝐍𝐅𝐎❗]SORRY, I MADE AN ERROR, TRY AGAIN. DO NOT FORGET TO RESPOND TO A VIDEO IMAGE OR INSERT THE LINK OF AN IMAGE FINISHING .jpg OF WHICH IT WILL BE CONVERTED INTO A STICKER* '
}}
