...
if (!args[0]) throw `*[❗𝐈𝐍𝐅𝐎❗] 𝙸𝙽𝙶𝚁𝙴𝚂𝙴 𝚄𝙽 𝙴𝙽𝙻𝙰𝙲𝙴 𝚅𝙰𝙻𝙸𝙳𝙾 𝙳𝙴 𝙼𝙴𝙳𝙸𝙰𝙵𝙸𝚁𝙴, 𝙴𝙹𝙴𝙼𝙿𝙻𝙾: ${usedPrefix + command} https://www.mediafire.com/file/h9x1bgb79vmllkn/Annie.zip/file*`
try {
let json = await mediafireDl2(args[0])
let caption = `ㅤㅤ╭┈─┈─┈─┈─┈─┈─┈─┈─┈─┈─┈╮
┈─𖨂 : *ʚ🩵ɞ  AnnieBot ✨ ⤾·˚ ༘*
┈─𖨂 : 🍀*𝙽𝙾𝙼𝙱𝚁𝙴:*  ${json[0].nama.replace('+', ' ')}
┈─𖨂 : 💎*𝙿𝙴𝚂𝙾:* ${json[0].size}
┈─𖨂 : 🌴*𝚃𝙸𝙿𝙾:* ${json[0].mime.toUpperCase()}
ㅤㅤ╰┈─┈─┈─┈─┈─┈─┈─┈─┈─┈─┈╯
