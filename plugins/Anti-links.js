...
if (!isBotAdmin) return m.reply('*[❗ERROR❗] 𝙴𝙻 𝙱𝙾𝚃 𝙽𝙾 𝙴𝚂 𝙰𝙳𝙼𝙸𝙽, 𝙽𝙾 𝙿𝚄𝙴𝙳𝙴 𝙴𝚇𝚃𝙴𝚁𝙼𝙸𝙽𝙰𝚁 𝙰 𝙻𝙰𝚂 𝙿𝙴𝚁𝚂𝙾𝙽𝙰𝚂*')  
...
} else if (!bot.restrict) return m.reply('*[❗𝐈𝐍𝐅𝐎❗] El propietario del bot no tiene habilitadas las restricciones, (#𝚎𝚗𝚊𝚋𝚕𝚎 𝚛𝚎𝚜𝚝𝚛𝚒𝚌𝚝) contactelo para que las habilite.*')
}
return !0
}
